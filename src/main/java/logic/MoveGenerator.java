...
public class MoveGenerator {
	...
	static boolean isValidSkip(Board board,
		...
		if (id == Board.INVALID || id == Board.EMPTY) {
			...
			return false;
		} else return (midID == Board.BLACK_CHECKER || midID == Board.BLACK_KING) == (id == Board.WHITE_CHECKER || id == Board.WHITE_KING);
	}

	static void addPoints(List<Point> points, Point p, int id, int delta) {
